<template>
  <div class="ele-body">
    <el-card :bordered="false" style="margin: 20px 20px 2px">
      <el-form >
        <el-row :gutter="8">
    ...
    <el-card style="height: 562px; margin: 0 20px; margin-top: 10px" :bordered="false"
      :body-style="{ padding: '16px 40px' }" >
      <v-chart v-if="current && current.length" ref="onLineCountChartRef" :option="onLineCountData" style="height: 562px" />
