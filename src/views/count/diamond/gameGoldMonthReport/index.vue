<template>
  <el-card :bordered="false">
    ...
    <!-- 表格 -->
    <ele-pro-table 
      ref="tableRef" :show-summary="true" :summary-method="getSummaries"
      :striped="true"
      :bordered="true"
      row-key="id"
      :columns="columns"
      ...
      :scroll="{ x: 1000 }"
      :where="defaultWhere"
      cache-key="progameGoldMonthReport">
       <!-- <template #toolbar>
...
<script setup lang="ts">
  ...
  import { pageGameDiamondMonthReports } from '@/api/count/gameGoldDayReport';
  import type { GameGoldMonthReports } from '@/api/count/model';
  import GameGoldChart from '@/views/count/diamond/gameGoldDayReport/components/gameGoldChart.vue';
  import GameGoldDayReportInfo from '@/views/count/diamond/gameGoldDayReport/components/gameGoldDayReportInfo.vue';
  ...
  const datasource: DatasourceFunction = ({ pages, limit, where, orders }) => {
    ...
    return pageGameDiamondMonthReports({ ...where, ...pages, limit });
  };
