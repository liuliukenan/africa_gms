<template>
  <div class="ele-body" style="margin: 20px;">
    <el-card :bordered="false">
      ...
      <!-- 表格 -->
      <ele-pro-table ref="tableRef" :striped="true" :bordered="true" row-key="id" :columns="columns" :headerEllipsis="false" :pagination="false" :show-summary="true" :summary-method="getSummaries" :datasource="datasource" :scroll="{ x: 1000 }" :where="defaultWhere" cache-key="prowithdrawComplexCount">
        <!-- <template #toolbar>
...
<script setup lang="ts">
  ...
  import { pageWithdrawDiamondCount } from '@/api/count/withdrawComplexCount';
  ...
  const datasource: DatasourceFunction = ({ page, limit, where, orders }) => {
    return pageWithdrawDiamondCount({ ...where, ...orders, limit, page });
  };
