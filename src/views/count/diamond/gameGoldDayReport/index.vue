    ...
    <el-tabs v-model="activeName" type="card" class="demo-tabs">
      <el-tab-pane label="每日" name="first">
        <el-card :bordered="false">
          ...
          <!-- 表格 -->
          <ele-pro-table ref="tableRef" :striped="true" :bordered="true" row-key="id" :columns="columns" size="small"  :show-summary="true" :summary-method="getSummaries"
            :pagination="{
              pageSize: 50,
...
import { pageGameDiamondDayReports } from '@/api/count/gameGoldDayReport';
import type { GameGoldDayReports } from '@/api/count/model';
// 总计
import GameGoldReport from '@/views/count/diamond/gameGoldReport/index.vue';
import GameGoldMonthReport from '@/views/count/diamond/gameGoldMonthReport/index.vue';
...
const datasource: DatasourceFunction = ({ pages, limit, where, orders }) => {
  ...
  return pageGameDiamondDayReports({ ...where, ...pages, limit });
};
