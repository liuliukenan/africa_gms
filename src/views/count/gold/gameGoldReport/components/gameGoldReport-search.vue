    ...
    <el-row :gutter="8">
      ...
      <el-col :xl="6" :lg="6" :md="12" :sm="12" :xs="24">
        <el-form-item label="时间">
          <!-- <el-date-picker v-model="timeArr" type="daterange" range-separator="至" start-placeholder="开始" :value-format="'YYYY'" end-placeholder="结束" /> -->
          <el-date-picker v-model="timeArr" type="yearrange" :value-format="'YYYY'" range-separator="至"
...
let timeArr = ref<[string, string]>([dayjs().subtract(1, 'year').format('YYYY'), dayjs().format('YYYY')]);
...
const search = () => {
  ...
  console.log('params', { ...form, startDay, endDay });
