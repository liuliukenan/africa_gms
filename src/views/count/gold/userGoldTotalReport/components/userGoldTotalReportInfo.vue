...
<script setup lang="ts">
  ...
  import { pageUserGoldTotalReportsInfo } from '@/api/count/userGoldTotalReport';
  ...
  const datasource: DatasourceFunction = async ({ page, limit, ...rest }) => {
    ...
    try {
      const response = await pageUserGoldTotalReportsInfo(props?.data.uid);
  ...
  //   return pageUserGoldTotalReportsInfo(props?.data.uid);
  // };
