...
<script lang="ts" setup>
  ...
  import { getNormalAgentTop10 } from '@/api/agent/agentOverviewApi';
  import { AgentOverviewParam, NormalAgentTop10 } from '@/api/agent/model/agentOverview';
  ...
  /** 表格选中数据 */
  const selections = ref<NormalAgentTop10[]>([]);
