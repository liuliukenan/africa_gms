<template>
  <ele-page>
    <ele-card :body-style="{ paddingTop: '8px' }">
      ...
      <BaseConfig />
      <ele-pro-table ref="tableRef" row-key="id" :columns="columns" :datasource="datasource" :show-overflow-tooltip="true" :border="true" :header-ellipsis="false" v-model:selections="selections" :highlight-current-row="true" :export-config="{ fileName: '代理配置配置', datasource: exportSource }" :print-config="{ datasource: exportSource }" :footer-style="{ paddingBottom: '16px' }" cache-key="systemUserTable">
        <template #toolbar>
...
<script lang="ts" setup>
  ...
  const columns = ref<Columns>([
    ...
    // {
    //   prop: "rsTotalPaidUserCount",
    //   label: "[RS] 总付费人数阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    // {
    //   prop: "rsTotalGgr",
    //   label: "[RS] 团队总GGR阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    // {
    //   prop: "rsCycleGgr",
    //   label: "[RS] 结算周期内团队GGR阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    // {
    //   prop: "rsCycleNewPaidUserCount",
    //   label: "[RS] 结算周期内新增付费用户阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    // {
    //   prop: "cpaTotalPaidUserCount",
    //   label: "[CPA] 总付费人数阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    // {
    //   prop: "cpaTotalRechargeAmount",
    //   label: "[CPA] 总充值金额阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    // {
    //   prop: "cpaCycleRechargeAmount",
    //   label: "[CPA] 周期内总充值金额阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    // {
    //   prop: "cpaCycleNewPaidUserCount",
    //   label: "[CPA] 周期内新增付费用户阈值（仅普代直属下属）",
    //   minWidth: 130,
    //   align: 'left',
    // },
    {
      prop: 'maTotalPaidUserCount',
      label: '总付费人数阈值（含直属+普代直属）',
      minWidth: 130,
      align: 'left'
    },
    // {
    //   prop: 'maTotalRechargeAmount',
    //   label: '总充值金额阈值（含直属+普代直属）',
    //   minWidth: 130,
    //   align: 'left'
    // },
    {
      prop: 'maCycleNewPaidUserCount',
      label: '结算周期内新增付费用户阈值（含直属+普代直属）',
      minWidth: 130,
      align: 'left'
    },
    {
      prop: 'maTotalGgr',
      label: '团队总GGR阈值（含直属+普代直属）',
      minWidth: 130,
      align: 'left'
    },
    // {
    //   prop: 'maCycleGgr',
    //   label: '团队周期内GGR阈值（含直属+普代直属）',
    //   minWidth: 130,
    //   align: 'left'
    // },
    {
