      ...
      <el-row :gutter="8">
        ...
        <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item label="渠道">
            <el-select v-model="form.channel" placeholder="请选择渠道" style="width: 100%" clearable filterable>
        ...
        <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item label="身份类型">
            <el-select v-model="form.agentType" placeholder="请选择" style="width: 100%" clearable>
        ...
        <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item label="返利模式">
            <el-select v-model="form.commissionModel" placeholder="请选择" style="width: 100%" clearable>
        ...
        <el-col v-show="searchExpand" :lg="7" :md="7" :sm="12" :xs="24">
          <el-form-item label="注册时间">
            <el-date-picker v-model="timeArr" type="datetimerange" value-format="YYYY-MM-DD HH:mm:ss" :default-time="defaultTime" range-separator="至"
