            ...
            <el-row :gutter="8">
                ...
                <el-col   :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="类型">
                        <el-input  clearable  v-model.trim="form.triggerSpinType"  placeholder="请输入" />
                    </el-form-item>
                </el-col>
                ...
                <el-col  v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="有效天数">
                        <el-input  clearable  v-model.trim="form.validDays"  placeholder="请输入" />
                    </el-form-item>
                </el-col>
                <el-col  v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                ...
                <el-col  v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="次数">
                        <el-input  clearable  v-model.trim="form.totalSpins"  placeholder="请输入" />
                    </el-form-item>
                </el-col>
                <el-col :lg="6" :md="6" :sm="12" :xs="24">
...
<script lang="ts" setup>
    ...
    import type { FreeGameConfParam } from '@/api/platform/model/freeGameConf';

    const emit = defineEmits<{
      (e: 'search', where?: FreeGameConfParam): void;
    }>();
    /** 表单数据 */
    const [form, resetFields] = useFormData<FreeGameConfParam>({
          id:undefined,
          name:"",
