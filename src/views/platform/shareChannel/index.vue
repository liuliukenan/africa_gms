...
<script setup lang="ts">
  ...
  import BaseConfig from './components/add-channel-config.vue';
  import RewardRecords from './components/channel-edit-records.vue';
  ...
  const allTabs = computed(() => [
    {
      label: '渠道配置',
      name: 'first',
      // permission: 'platform:channel:config',
      permission: '',
    ...
    },
    {
      label: '修改记录',
      name: 'second',
      // permission: 'platform:channel:records',
      permission: '',
