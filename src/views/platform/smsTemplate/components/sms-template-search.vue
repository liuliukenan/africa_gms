...
<script lang="ts" setup>
  ...
  import type { SmsTemplateQuery } from '@/api/platform/model/smsTemplate';
  import { useConfigStore } from '@/store/modules/config';

  const configStore = useConfigStore();

  const emit = defineEmits<{
    (e: 'search', where?: SmsTemplateQuery): void;
  }>();

  /** 表单数据 */
  const [form, resetFields] = useFormData<SmsTemplateQuery>({
