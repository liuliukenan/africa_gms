...
import PuushRecords from './components/push-records.vue';
...
const allTabs = computed(() => [
    {
        label: t('welfare.repay.tabConfig'),
        name: 'first',
        permission: 'welfare:repay:config',
        component: ActivityConfig
    },
    {
        label: t('welfare.repay.tabRecords'),
        name: 'second',
        permission: 'welfare:repay:records',
        component: Records
    },
    {
        label: t('welfare.repay.pushRecords'),
        name: 'third',
        permission: 'welfare:repay:pushRecords',
        component: PuushRecords
    },
]);
