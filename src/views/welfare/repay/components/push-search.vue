  ...
  <ele-card :body-style="{ padding: '0px' }">
    <el-form @keyup.enter="search" @submit.prevent="">
      <el-row :gutter="8">
        ...
        <!-- 推送渠道 -->
        <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
          <el-form-item :label="t('welfare.repay.pushTable.pushChannel')">
            <el-select v-model="form.pushChannel" :placeholder="t('common.placeholder.select')" clearable style="width: 100%">
              ...
              <el-option label="APP_PUSH" value="APP_PUSH" />
        ...
        <!-- 任务状态 -->
        <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
          <el-form-item :label="t('welfare.repay.pushTable.status')">
...
<script lang="ts" setup>
  ...
  import type { ActPushTaskParam } from '@/api/welfare/model/repay';
