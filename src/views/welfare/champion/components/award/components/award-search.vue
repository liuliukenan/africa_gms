      ...
      <el-row :gutter="8">
        ...
        <el-col :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item label="用户名">
            <el-input clearable  v-model.trim="form.username" placeholder="请输入用户名" />
          </el-form-item>
        </el-col>
...
import type { AwardParam } from "@/api/welfare/model/index";
...
/** 表单数据 */
const [form, resetFields] = useFormData<AwardParam>({
  periods: undefined,
  uid: undefined,
  username: undefined,
});
