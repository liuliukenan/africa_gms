<!-- 用户编辑弹窗 -->
<template>
    <ele-modal form :width="1024" v-model="visible" :title="'中奖信息'" @open="handleOpen">
        <el-descriptions v-if="form" :border="true" :column="mobile ? 1 : 3" class="detail-table">
            ...
            <el-descriptions-item label="排期名称">
                <div> {{ form.periodName }}</div>
            </el-descriptions-item>
            <el-descriptions-item label="排期序号">
                <div> {{ form.periodNum }}</div>
            </el-descriptions-item>
