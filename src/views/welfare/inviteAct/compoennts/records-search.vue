            ...
            <el-row :gutter="8">
                ...
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="邀请类型">
                        <dict-data code="act_sub_type" v-model="form.subType"  value-type="string" />
                    </el-form-item>
                </el-col>
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
...
import type { ActRecordParam } from '@/api/welfare/model/inviteAct';
import dayjs from 'dayjs';
import { ElMessage } from 'element-plus';
import { useConfigStore } from '@/store/modules/config';

const emit = defineEmits<{
    (e: 'search', where?: ActRecordParam): void;
}>();

const configStore = useConfigStore();

const [form, resetFields] = useFormData<ActRecordParam>({
