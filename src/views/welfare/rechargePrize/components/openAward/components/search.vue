      ...
      <el-row :gutter="8">
        <el-col :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item label="用户ID">
            <el-input clearable v-model.trim="form.id" placeholder="请输入用户ID" />
          </el-form-item>
        </el-col>
        <el-col :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item label="期数">
            <el-input clearable v-model.trim="form.issue" placeholder="请输入期数" />
          </el-form-item>
        </el-col>
...
import type { LotteryParam } from "@/api/lottery/model/index";
import dayjs from 'dayjs';
import { ref } from 'vue';
const emit = defineEmits<{
  (e: 'search', where?: LotteryParam): void;
}>();
/** 表单数据 */
const [form, resetFields] = useFormData<LotteryParam>({
  issue: undefined,
  uid: undefined,
  lotteryType: 0,
  startDay: undefined,
