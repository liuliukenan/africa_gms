...
const allTabs = computed(() => [
    {
        label: t('welfare.cashWheel.tabConfig'),
        name: 'first',
        permission: 'welfare:cashWheel:config',
        component: BaseConfig
    },
     {
        label: t('welfare.cashWheel.robot'),
        name: 'second',
        permission: 'welfare:cashWheel:robot',
        component: Robot
    },
    {
        label: t('welfare.cashWheel.tabRecords'),
        name: 'third',
        permission: 'welfare:cashWheel:records',
        component: RewardRecords
    },
    {
        label: t('welfare.cashWheel.pushRecords'),
        name: 'fourth',
        permission: 'welfare:cashWheel:pushRecords',
