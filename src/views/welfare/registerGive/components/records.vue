...
import { pageRegisterRecord, exportRegisterRecord } from '@/api/welfare/registerGiveApi';
...
const datasource: DatasourceFunction = ({ pages, where, orders }) => {
    return pageRegisterRecord({ ...defaultWhere, ...where, ...orders, ...pages });
};
...
const openExport = () => {
    exportRegisterRecord({ ...searchRef.value!.searchParams() }, 'RegisterRecords').then((res) => {
