...
import type { DailyRechargeSurpriseRobotTextQuery } from '@/api/welfare/model/dailySurprise';
...
const emit = defineEmits<{
  (e: 'search', where?: DailyRechargeSurpriseRobotTextQuery): void;
}>();

const configStore = useConfigStore();

const [form, resetFields] = useFormData<DailyRechargeSurpriseRobotTextQuery>({
