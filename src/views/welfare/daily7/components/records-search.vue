    ...
    <el-form @keyup.enter="search" @submit.prevent="">
      <el-row :gutter="8">
        ...
        <el-col :lg="7" :md="7" :sm="12" :xs="24">
          <el-form-item :label="t('welfare.daily7.timeArr')">
        ...
        <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
          <el-form-item :label="t('welfare.daily7.table.uid')">
            <el-input-number v-model="form.uid" :placeholder="t('common.placeholder.input')" clearable style="width: 100%" :controls="false"/>
          </el-form-item>
        </el-col>
        <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
          <el-form-item :label="t('welfare.daily7.table.invitedPhone')">
            <el-input v-model="form.invitedPhone" :placeholder="t('common.placeholder.input')" clearable />
          </el-form-item>
        </el-col>
        <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
          <el-form-item :label="t('welfare.daily7.table.round')">
            <el-input-number v-model="form.round" :placeholder="t('common.placeholder.input')" clearable style="width: 100%" :controls="false"/>
          </el-form-item>
        </el-col>
        <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
          <el-form-item :label="t('welfare.daily7.table.subType')">
            <el-input-number v-model="form.subType" :placeholder="t('common.placeholder.input')" clearable style="width: 100%" :controls="false"/>
            <!-- <el-input v-model="form.subType" :placeholder="t('common.placeholder.input')" clearable style="width: 100%"/> -->
          </el-form-item>
        </el-col>
        <!-- <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
...
<script lang="ts" setup>
  ...
  import type { Daily7RecordParam } from '@/api/welfare/model/daily7';
  ...
  const emit = defineEmits<{
    (e: 'search', where?: Daily7RecordParam): void;
  }>();

  const configStore = useConfigStore();

  const [form, resetFields] = useFormData<Daily7RecordParam>({
