...
import type { FirstPayRecordParam } from '@/api/welfare/model/firstPayGive';
import dayjs from 'dayjs';
import { ElMessage } from 'element-plus';
import { useConfigStore } from '@/store/modules/config';

const emit = defineEmits<{
    (e: 'search', where?: FirstPayRecordParam): void;
}>();

const configStore = useConfigStore();

const [form, resetFields] = useFormData<FirstPayRecordParam>({
