            ...
            <el-row :gutter="16">
                ...
                <el-col :sm="12" :xs="12">
                    <el-form-item label="电子" name="slots">
                        <el-input-number :controls="false" v-model="form.slots" :min="0"  placeholder="请输入" :precision="3"
                            style="width:100%" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="16">
                <el-col :sm="12" :xs="12">
                    <el-form-item label="桌面" name="cards">
                        <el-input-number :controls="false" v-model="form.cards" :min="0"  placeholder="请输入" :precision="3"
                            style="width:100%" />
                    </el-form-item>
                </el-col>
                <el-col :sm="12" :xs="12">
                    <el-form-item label="捕鱼" name="fish">
                        <el-input-number :controls="false" v-model="form.fish" :min="0"  placeholder="请输入" :precision="3"
                            style="width:100%" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="16">
                <el-col :sm="12" :xs="12">
                    <el-form-item label="真人" name="live">
                        <el-input-number :controls="false" v-model="form.live" :min="0"  placeholder="请输入" :precision="3"
                            style="width:100%" />
                    </el-form-item>
                </el-col>
                <el-col :sm="12" :xs="12">
                    <el-form-item label="体育" name="sports">
                        <el-input-number :controls="false" v-model="form.sports" :min="0"  placeholder="请输入" :precision="3"
                            style="width:100%" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="16">
                <el-col :sm="12" :xs="12">
                    <el-form-item label="彩票" name="lottery">
                        <el-input-number :controls="false" v-model="form.lottery" :min="0"  placeholder="请输入" :precision="3"
                            style="width:100%" />
                    </el-form-item>
                </el-col>
                <el-col :sm="12" :xs="12">
                    <el-form-item label="其它" name="other">
                        <el-input-number :controls="false" v-model="form.other" :min="0"  placeholder="请输入" :precision="3"
                            style="width:100%" />
                    </el-form-item>
                </el-col>
            </el-row>
