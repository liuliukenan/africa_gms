            ...
            <el-row :gutter="8">
                ...
                <el-col :lg="6" :md="6" :sm="12" :xs="24">
                  ...
                  <el-col :lg="7" :md="7" :sm="12" :xs="24" >
                    <el-form-item label="时间">
                        <el-date-picker v-model="timeArr" type="datetimerange" value-format="YYYY-MM-DD HH:mm:ss" :default-time="defaultTime"
                ...
                <!-- <el-col :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="支付渠道">
                        <dict-data code="channelType" v-model="form.payChannel" valueType="string" @change="search" />
                    </el-form-item>
                </el-col> -->
                <el-col :lg="6" :md="6" :sm="12" :xs="24" v-show="searchExpand">
