            ...
            <el-row :gutter="8">
                ...
                <el-col :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="时间">
                        <el-date-picker v-model="timeArr" type="daterange" :value-format="'YYYY-MM-DD'"
                            @change="search" range-separator="至" start-placeholder="开始"
                ...
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="流水类型">
                        <el-select v-model="form.queryType" placeholder="请选择" clearable style="width: 100%;">
                            <el-option label="cash" :value="0" />
                            <!-- <el-option label="company" :value="1" /> -->
                            <el-option label="group" :value="2" />
                            <el-option label="game" :value="3" />
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="流水类型">
                        <dict-data code="flow_type_common" v-model="form.flowType" valueType="number" multiple />
                    </el-form-item>
                </el-col>
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
...
import type { CommonFlowRecordParam } from '@/api/user/model/commonFlowList';
import dayjs from 'dayjs';
import { ElMessage } from 'element-plus';
import { useConfigStore } from '@/store/modules/config';

const emit = defineEmits<{
    (e: 'search', where?: CommonFlowRecordParam): void;
}>();

const configStore = useConfigStore();

const [form, resetFields] = useFormData<CommonFlowRecordParam>({
    uid: undefined,
    queryType: undefined,
    flowType: undefined,
    status: undefined,
