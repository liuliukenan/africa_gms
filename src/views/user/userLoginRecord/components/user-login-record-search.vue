    ...
    <el-form @keyup.enter="search" @submit.prevent="">
      <el-row :gutter="8">
        ...
        <el-col :lg="7" :md="7" :sm="12" :xs="24">
          <el-form-item :label="t('user.userLoginRecord.timeArr')">
        ...
        <el-col :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item :label="t('user.userLoginRecord.table.uid')">
        ...
        <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item :label="t('user.userLoginRecord.table.phone')">
            <el-input clearable v-model.trim="form.phone" :placeholder="t('common.placeholder.input')" />
          </el-form-item>
        </el-col>
        <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
          <el-form-item label="设备ID">
            <el-input clearable v-model.trim="form.deviceId" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
...
<script lang="ts" setup>
  ...
  const emit = defineEmits<{
    (e: 'search', where?: UserLoginRecordParam): void;
  }>();
  ...
  /** 表单数据 */
  const [form, resetFields] = useFormData<UserLoginRecordParam>({
    id: undefined,
    phone: undefined,
    deviceId: undefined,
    startDate: undefined,
  ...
  const search = () => {
    ...
    if (startDay && endDay) {
      ...
      if (diffDays > 90) {
        ElMessage.warning(t('user.userLoginRecord.maxTimeSpanWarning'));
