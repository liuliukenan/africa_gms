            ...
            <el-row :gutter="8">
                ...
                <el-col :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="真实姓名">
                        <el-input v-model.trim="form.realName" clearable placeholder="请输入" />
                    </el-form-item>
                </el-col>
                ...
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="用户ID">
                        <el-input v-model.trim="form.uid" clearable placeholder="请输入" />
                    </el-form-item>
                </el-col>
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="证件号">
                        <el-input v-model.trim="form.nationalId" clearable placeholder="请输入" />
                    </el-form-item>
                </el-col>
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                ...
                <el-col v-show="searchExpand" :lg="6" :md="6" :sm="12" :xs="24">
                    <el-form-item label="审核人ID">
                        <el-input v-model.trim="form.handleBy" clearable placeholder="请输入" />
                    </el-form-item>
                </el-col>
...
import type { ListKycRecordParam } from '@/api/user/model/listKycRecord';
import dayjs from 'dayjs';
import { ElMessage } from 'element-plus';
import { useConfigStore } from '@/store/modules/config';

const emit = defineEmits<{
    (e: 'search', where?: ListKycRecordParam): void;
}>();

const configStore = useConfigStore();

const [form, resetFields] = useFormData<ListKycRecordParam>({
    uid: undefined,
    realName: undefined,
