    ...
    <el-form @submit.prevent="">
      <el-row :gutter="16">
        <el-col :lg="24" :md="24" :sm="24" :xs="24">
          <el-popconfirm :title="`确认导出机器人配置表吗？`" @confirm="doExcelExport()" width='240px'>
            <template #reference>
...
import { exportExcel, importExcel } from '@/api/config/robotApi';
...
const doExcelExport = () => {
  exportExcel().then((res) => {
    handleDownload('机器人配置表', res.data as any);
  });
};
